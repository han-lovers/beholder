...
response_1=`curl -s -X POST http://127.0.0.1:8000/v1/register \
...
response_2=`curl -s -X POST http://127.0.0.1:8000/v1/register \
-H "Content-Type: application/json" \
...
response_3=`curl -s -X POST http://127.0.0.1:8000/v1/register \
-H "Content-Type: application/json" \
